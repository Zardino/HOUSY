...
struct SideMenuView: View {
    ...
    var body: some View {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(spacing: 0) {
                    ...
                    MenuItemView(
                        ...
                        // NB: se chiudi il menu immediatamente, la sheet può non aprirsi.
        ...
        .sheet(isPresented: $showSavedProjects, onDismiss: {
            // quando chiudi la lista progetti, chiudi anche il menu
            isPresented = false
        }) {
